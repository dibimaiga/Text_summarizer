...
from TextSummarizationProject.entity import ModelEvaluationConfig
...
class ModelEvaluation:
    ...
    def evaluate(self):
        ...
        score = self.calculate_metric_on_test_ds(dataset["test"][0:10], rouge_metric, model, tokenizer,batch_size=2,column_text="dialogue", column_summary="summary")
